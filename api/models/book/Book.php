...
class Book extends \common\models\book\Book
{
    ...
    {
        return [
            ['channel_id','integer','message'=>'需要用整形,自定义报错'],
            [[ 'cid', 'source_id', 'author_id', 'total_price', 'words_price', 'chapter_price', 'free_chapters', 'status', 'online_status', 'weight', 'is_vip', 'is_baoyue', 'is_hot', 'is_new', 'is_yy', 'is_greatest', 'is_god', 'is_sensitivity', 'total_words', 'total_chapters', 'total_views', 'total_favors', 'last_chapter_id', 'last_chapter_time', 'chapter_update_remind', 'audio_id', 'store_type', 'lang_id', 'created_at', 'updated_at', 'deleted_at'], 'integer'],
            ...
            [['cover'], 'checkString', 'params'=>['message'=>'自定义函数验证报错']],

        ];
    }


    public function checkString($attribute,$params){
       // $attribute 就是cover
